<script>
  ...
  const stats =obtenerEstadisticasFinancieras();
  const transactions = obtenerTransacciones();
  const summary = obtenerResumenFinanciero();
</script>
        ...
        <div class="tarjeta-estadistica">
          ...
          <div class="contenido-estadistica">
            <span class="valor-estadistica"
              >${stats.monthlyIncome.toLocaleString()}</span
            >
              ...
              <tbody>
                {#each transactions as transaction}
                  <tr>
                    ...
                    <td
                      class={transaction.amount > 0 ? "positivo" : "negativo"}
                    >
          ...
          <div class="lista-resumen">
            <div class="elemento-resumen">
              ...
              <span class="valor positivo"
                >+${summary.totalIncome.toLocaleString()}</span
              >
            </div>
            ...
            <div class="elemento-resumen">
              ...
              <span class="valor negativo"
                >-${summary.totalExpenses.toLocaleString()}</span
              >
            </div>
